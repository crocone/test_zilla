...
export const STATUS_TEXT: Record<string, string>[] = [{STATUS_WAIT: 'Ожидание'}, {STATUS_CANCELED: 'Отменен'}, {STATUS_COMPLETE: 'Выполнен'}, {STATUS_PROCESS: 'Процессинг'}, {STATUS_REFUND: 'Возврат'}];
